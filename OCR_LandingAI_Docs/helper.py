...
def draw_bounding_boxes_2(groundings, document_path, base_path="."):
    ...
    def create_annotated_image(image, groundings, page_num=0):
        ...
        print(f"Creating annotated image for page {page_num + 1} with {len(groundings)} groundings...")
    ...
    print(f"Drawing bounding boxes for document: {document_path} with {len(groundings)} groundings...")
    ...
    if document_path.suffix.lower() == '.pdf':
        ...
        print(f"Document is an image. Processing directly...")
